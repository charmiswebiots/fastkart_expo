...
export function into (props) {
    const { colors } = useTheme();
    return (
        <Svg width={props.width ? props.width : windowWidth(34)} height={props.height ? props.height : windowHeight(34)} viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/3000/svg">
