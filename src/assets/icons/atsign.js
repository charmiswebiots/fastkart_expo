...
export function atSign() {
    ...
    return (
        <Svg width={windowWidth(23)} height={windowHeight(23)} viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            <Path d="M8.50002 11.3334C10.0648 11.3334 11.3334 10.0649 11.3334 8.50008C11.3334 6.93527 10.0648 5.66675 8.50002 5.66675C6.93521 5.66675 5.66669 6.93527 5.66669 8.50008C5.66669 10.0649 6.93521 11.3334 8.50002 11.3334Z" stroke={colors.text} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
