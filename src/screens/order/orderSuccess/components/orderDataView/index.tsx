    ...
    return (
        <View style={[styles.totalView, { flexDirection: viewRtlStyle }]} >
            {loading ? (
                ...
                <>
                    <View style={{ flexDirection: viewRtlStyle } as StyleProp<ViewStyle>}>
                        <View style={styles.optionView}>
                            <Icons.calender />
                        </View>
                        <View style={styles.option}>
                            <Text style={[styles.orderDate, { color: colors.text } as TextStyle]}>{t('orderSuccessPage.orderDate')}</Text>
                    ...
                    <View style={{ flexDirection: viewRtlStyle } as StyleProp<ViewStyle>}>
                        ...
                        <View style={styles.option}>
                            <Text style={[styles.orderDate, { color: colors.text }, { textAlign: textRtlStyle } as TextStyle]}>{t('orderSuccessPage.idOrder')}</Text>
