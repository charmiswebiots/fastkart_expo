...
import { Header, Total, Button } from "../../../commonComponents";
import images from "../../../utils/images";
import { ThankyouView } from "./components";
import { OrderDataView } from "./components";
import { Icons } from "../../../utils/icons";
import { useTheme } from "@react-navigation/native";
import { useValues } from "../../../utils/context";
import { windowHeight } from "../../../theme/appConstant";
...
export function OrderSuccess({ navigation }: OrderSuccessProps) {
    const { colors } = useTheme();
    const { isDark, t } = useValues();

    const orderTracking = (): void => {
        navigation.navigate('OrderTracking');
    };
